      ...
      <html>
        ...
        <body>
          ...
          <div class="content">
            ...
            <div class="info-row">
              <span class="label">Date:</span> ${new Date(documentData.generated_date).toLocaleDateString()}
            </div>
            <div style="margin-top: 30px;">
              <p>This is a ${documentData.document_type.toLowerCase()} document dated ${new Date(documentData.generated_date).toLocaleDateString()}.</p>
              <p>Document ID: ${documentData.document_id}</p>
            </div>
          </div>
          <div class="footer">
            <p>Prime Living Management System</p>
  ...
  const handleGenerateDocument = async () => {
    ...
    toast({
      title: "Document Ready",
          description: `${selectedDocumentType} for ${selectedTenant} has been created and downloaded.`,
        });
      }
    } catch (error) {
      ...
      <nav className="bg-white border-b border-gray-200 px-6">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-7">
            ...
            <TabsTrigger value="documents">Contract</TabsTrigger>
